return function(properties, textColour)
	...
	if not properties.backgroundColour then properties.backgroundColour = colour.rgb(255, 255, 255) end
	...
	local dropShadow = core.construct(
                   					"guiFrame", {
						parent = mainBackdrop,

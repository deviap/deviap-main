...
tween = core.tween:begin(
        				pattern, 10, {imageTopLeft = vector2(-120, 120)}, "linear", function()
					tween:reset()
					tween:resume()
				end)
...
breakpointer:bind(
				sideContainer, "xs", {size = guiCoord(1, -50, 1, -50), position = guiCoord(0, 25, 0, 25)})

breakpointer:bind(
				sideContainer, "md", {size = guiCoord(0.5, 0, 1, -200), position = guiCoord(0.5, 0, 0, 100)})

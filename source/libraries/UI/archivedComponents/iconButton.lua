...
return function(props)
    ...
    self.child:on("mouseEnter",
                  function() self.states.dispatch({type = "hover"}) end)
    self.child:on("mouseExit", function()
        self.states.dispatch({type = "unhover"})
        self.states.dispatch({type = "deactivate"})
    end)
    self.child:on("mouseLeftUp",
                  function() self.states.dispatch({type = "deactivate"}) end)
    self.child:on("mouseLeftDown",
                  function() self.states.dispatch({type = "activate"}) end)
